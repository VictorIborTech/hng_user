...
urlpatterns = [
    ...
    path('api/organisations/<str:id>', OrganisationDetailView.as_view(), name='organisation-detail'),
    path('api/organisations/<str:id>/users', AddUserToOrganisationView.as_view(), name='add-user-to-organisation'),
